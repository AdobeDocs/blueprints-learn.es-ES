...
Este proyecto ha adoptado el [Código de conducta de código abierto de Adobe](code-of-conduct.md) o [Código de conducta de .NET Foundation](https://dotnetfoundation.org/code-of-conduct). Para más información, consulte el artículo [Contribución](contributing.md).
