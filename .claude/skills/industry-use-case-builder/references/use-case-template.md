...
---
# Plantilla de sección de caso de uso del sector

Cada caso de uso dentro de un archivo de información general del sector sigue esta estructura exacta.
...
### Ejemplo emergente (atención sanitaria)
