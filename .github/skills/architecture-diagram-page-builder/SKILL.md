...
**Use el formulario de preguntas disponible, no una entrevista lineal.** Recopile toda la información necesaria en rondas lógicas por lotes en lugar de hacer una pregunta a la vez. Esto mantiene la experiencia rápida y analizable para el usuario.

### Restricciones del formulario de pregunta

- Máximo de **4 preguntas** por formulario.
...
### Ronda 1: información sobre la página principal (un formulario de preguntas, hasta 4 preguntas)
...
### Ronda 2 — Detalles del diagrama (un formulario de preguntas, hasta 4 preguntas)
...
### Ronda 3: patrones de casos de uso (formulario de pregunta después del escaneo)

Antes de presentar este formulario, busque `/help/blueprints/use-case-patterns/` e identifique entre 3 y 5 patrones coincidentes probables en función del título de página, el propósito y las soluciones. Confirme que cada archivo existe antes de sugerirlo.
...
### Ronda 4: flujos de datos y vínculos Experience League (formulario de una pregunta)
...
**Vínculos de Experience League:** Después del formulario, presente una tabla de markdown de 4-6 vínculos sugeridos con título de artículo, dirección URL y una lógica de una línea. Marcar cada dirección URL como **sin comprobar**. Pida al usuario que (a) acepte, (b) sustituya por una URL verificada o (c) añada la suya propia. Utilice un formulario de preguntas de seguimiento con hasta 4 opciones si la lista es larga; de lo contrario, acepte la confirmación en texto sin formato.
...
2. **Vínculos de patrones de casos de uso**: cada vínculo de patrones del archivo señala a un archivo Markdown existente en `/help/blueprints/use-case-patterns/`. Utilice la búsqueda del espacio de trabajo o la lectura de archivos para confirmar que existe cada destino.
