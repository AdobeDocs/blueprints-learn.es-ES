...
# Patrón de caso de uso, generador de páginas
...
1. **Vínculos de objetivos empresariales**: todos los vínculos de objetivos empresariales del archivo de patrones apuntan a un archivo existente en `/help/blueprints/business-objectives/`. Utilice la búsqueda del espacio de trabajo o la lectura de archivos para confirmar que existe cada archivo de destino.
