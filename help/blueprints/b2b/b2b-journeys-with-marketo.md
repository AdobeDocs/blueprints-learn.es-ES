...
* Eventos de personas.
   ...
   * Y / O es compatible (por lo que puede decir &quot;A y B tienen que suceder,&quot;  pero no se puede decir &quot;A debe suceder 3 días antes de B&quot;).
* Máximo de 5 millones de cuentas en todos los recorridos de cuenta
* Un máximo de 40 millones de personas en todos los recorridos de la cuenta
* Máximo de 1.000 personas por cuenta en un grupo de compra y recorrido
* [Guardas de perfil y segmentación](https://experienceleague.adobe.com/en/docs/experience-platform/profile/guardrails)
