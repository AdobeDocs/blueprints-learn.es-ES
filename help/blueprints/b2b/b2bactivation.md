...
>[!TIP]
>Este modelo también está disponible como [patrón de caso de uso](/help/blueprints/use-case-patterns/b2b/account-audience-activation.md) en Activación y marketing B2B.
