...
| **[Activación de audiencia y perfil B2B](b2b-audience-profile-activation.md)** | <ul><li>Cree y active audiencias de personas y cuentas a partir de perfiles B2B unificados en canales y destinos</li></ul> | <ul><li>Adobe Real-Time Customer Data Platform B2B edition</li><li>Adobe Journey Optimizer B2B edition</li><li>Adobe Customer Journey Analytics B2B edition</li></ul> |
| **[Activación de cuenta B2B](b2b-account-activation.md)** | <ul><li>Active las audiencias de cuenta en destinos de publicidad y almacenamiento en la nube para el direccionamiento, el alcance de ventas y el análisis</li></ul> | <ul><li>Adobe Real-Time Customer Data Platform B2B edition</li></ul> |
