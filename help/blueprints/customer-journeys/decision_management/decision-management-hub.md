---
title: Gestión de decisiones en el centro
...
# Journey Optimizer: Administración de decisiones en el centro
...
Para obtener más información sobre Gestión de decisiones en Edge, consulte el modelo [Gestión de decisiones en Edge](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journeys/journey-optimizer/offer-decisioning/decision-management-edge.html).
...
<img src="../assets/offers_hub.svg" alt="Arquitectura de referencia Administración de decisiones en el modelo edge" style="width:100%; border:1px solid #4a4a4a" />
...
* Para la implementación basada en API de servidor de Administración de decisiones, aproveche la variable [API de decisiones](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/api-reference/offer-delivery/decisioning-vs-edge-apis.html?lang=es).
