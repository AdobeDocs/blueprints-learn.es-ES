...
Para obtener más información sobre Gestión de decisiones, consulte la documentación del producto [AQUÍ](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started-decision/starting-offer-decisioning.html?lang=es) y la Información general sobre Gestión de decisiones [AQUÍ](decision-management-overview.md)
...
Para obtener más información sobre Gestión de decisiones en Edge, consulte el modelo [Gestión de decisiones en Edge](decision-management-edge.md).
...
<img src="images/offers_hub.svg" alt="Arquitectura de referencia Gestión de decisiones en el modelo de Edge" style="width:100%; border:1px solid #4a4a4a" class="modal-image" />
...
[Protecciones y guía de latencia de extremo a extremo](/help/blueprints/experience-platform/guardrails.md)
...
* Para experiencias en tiempo real basadas en Edge, use la SDK web/móvil o la API de Edge Decisioning como se describe en [Administración de decisiones en el modelo de Edge](decision-management-edge.md)
