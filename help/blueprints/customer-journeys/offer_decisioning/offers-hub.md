---
title: Offer Decisioning en el hub
...
# Journey Optimizer: Offer Decisioning en el hub
...
Para obtener más información sobre Gestión de decisiones en Edge, consulte el modelo [Gestión de decisiones en Edge](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/customer-journeys/journey-optimizer/offer-decisioning/offers-edge.html).
...
* Proporcionar ofertas a ESP externo y sistemas de mensajería para su envío.
...
<img src="../assets/offers_hub.svg" alt="Arquitectura de referencia Offer Decisioning en el modelo de Edge" style="width:100%; border:1px solid #4a4a4a" />
...
* Para la implementación basada en API de servidor de Offer Decisioning, aproveche la [API Decisioning](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/api-reference/offer-delivery/decisioning-vs-edge-apis.html?lang=es).
