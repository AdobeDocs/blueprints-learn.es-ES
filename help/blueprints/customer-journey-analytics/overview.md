...
Se puede encontrar una lista completa de casos de uso junto con documentación [aquí](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/cja-usecases.html?lang=es).
