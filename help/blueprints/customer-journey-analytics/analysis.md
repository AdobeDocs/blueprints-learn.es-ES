...
description: Use Adobe [!DNL Experience Platform] (AEM) para realizar consultas y análisis exploratorios de los datos que existen en el lago de datos.
...
Consulte la documentación del producto del servicio de consultas para obtener más información sobre las prácticas recomendadas y las protecciones.
[Guía del servicio de consultas](https://experienceleague.adobe.com/docs/experience-platform/query/guardrails.html?lang=es)
