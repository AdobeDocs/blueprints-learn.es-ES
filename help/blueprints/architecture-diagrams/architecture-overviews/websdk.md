---
title: Adobe Experience Platform Web SDK y [!DNL Edge Network]
description: Este diagrama de arquitectura muestra la ingesta a través de Experience Platform Web y Mobile SDK y [!DNL Edge Network]
...
ht-degree: 60%
---
# Adobe Experience Platform Web SDK y [!DNL Edge Network]
...
![Arquitectura de referencia para la implementación mediante Experience Platform Web y Mobile SDK](assets/sdk_data_flow_diagram.png){width="1000" zoomable="yes"}

Diagrama de secuencias de Experience Edge, Experience Platform Services y aplicaciones

![Arquitectura de referencia para el escenario de Web Personalization en línea/sin conexión](assets/sdk_sequence_diagram.png){width="1000" zoomable="yes"}
