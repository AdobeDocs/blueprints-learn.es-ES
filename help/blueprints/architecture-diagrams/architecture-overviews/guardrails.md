---
title: Adobe Experience Platform y protecciones de aplicaciones
...
ht-degree: 13%
---
# Adobe Experience Platform y protecciones de aplicaciones
...
* [Introducción a las protecciones Real-Time CDP](https://experienceleague.adobe.com/docs/experience-platform/rtcdp/guardrails/overview.html?lang=es)
* [Protecciones de uso compartido de audiencias Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=es#latency)
* [Protecciones de ingesta de datos Customer Journey Analytics](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=es#what-is-the-expected-latency-for-analytics-data-on-platform%3F)
...
![Latencias observadas principales de Experience Platform [!DNL Edge Network] y hub.](/help/blueprints/architecture-diagrams/architecture-overviews/assets/aep_edge_hub_latency.png "Latencias observadas principales de Edge Network y hub de Experience Platform"){width="1000" zoomable="yes"}