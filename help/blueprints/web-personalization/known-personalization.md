---
title: Información general de personalización web y móvil
...
<img src="assets/RTCDP+Target.png" alt="Arquitectura de referencia del modelo de personalización del sitio web en línea/sin conexión" style="width:90%; border:1px solid #4a4a4a" />

Detalle de secuencia

<img src="assets/RTCDP+Target_flow.png" alt="Arquitectura de referencia del modelo de personalización del sitio web en línea/sin conexión" style="width:90%; border:1px solid #4a4a4a" />

Vista general de la arquitectura

<img src="assets/personalization_with_apps.png" alt="Arquitectura de referencia del modelo de personalización del sitio web en línea/sin conexión" style="width:90%; border:1px solid #4a4a4a"/>
...
* Para su uso en el SDK de Mobile, utilice la variable [Adobe Journey Optimizer: extensión de Decisioning](https://aep-sdks.gitbook.io/docs/using-mobile-extensions/adobe-journey-optimizer-decisioning) debe estar instalado en el SDK de Mobile.
...
* Tenga en cuenta que los datos cargados en el concentrador antes de que un consumidor visite o inicie sesión en un sitio web no estarán disponibles inmediatamente para su personalización. Primero debe existir un perfil edge activo para que se sincronicen los datos de hub. Una vez creado, el perfil de Edge se sincronizará con el perfil de hub de forma asíncrona, lo que dará como resultado la personalización de la página siguiente.
