...
<img src="assets/behavioral_personalization.png" alt="Arquitectura de referencia del modelo de personalización web basada en comportamiento" style="width:80%; border:1px solid #4a4a4a" />
