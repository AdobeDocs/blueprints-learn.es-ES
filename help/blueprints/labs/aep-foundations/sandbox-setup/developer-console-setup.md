...
1. Seleccione el perfil de producto que coincida con la zona protegida que utilizará y, a continuación, seleccione **Guardar la API configurada**

## Recopile sus valores

Abra la página de información general de **OAuth Server-to-Server** de sus credenciales. Necesita cuatro valores para el archivo de entorno de la CLI:
...
>[!NOTE]
>
>Copie los ámbitos predeterminados que se muestran en la página de credenciales; no es necesario agregar nada manualmente. Si ha agregado ambas API, la lista de ámbitos incluye ambas automáticamente.
