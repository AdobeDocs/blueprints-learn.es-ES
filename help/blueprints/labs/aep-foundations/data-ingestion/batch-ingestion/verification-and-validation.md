...
>[!NOTE]
>
>**Previsualizar conjunto de datos** muestra el lote exitoso más reciente en este conjunto de datos. No puede ver los lotes anteriores. Además, los datos complejos, como matrices y mapas, no se pueden ver hoy en día y aparecen como columnas vacías. Para obtener una vista más completa, debe utilizar SQL para explorar el conjunto de datos como se explica a continuación.
...
1. Para recuperar el esquema XDM junto con los datos, ejecute también la siguiente consulta SQL:
