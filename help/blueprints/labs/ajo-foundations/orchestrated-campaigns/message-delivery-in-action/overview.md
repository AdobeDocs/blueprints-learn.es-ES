...
- **Almacenes de datos —>** [Configurar canales de correo electrónico](../../data-stores/configure-email-channels/overview.md) *(este paso de configuración tarda hasta tres horas en completarse)*
...
En este laboratorio, creará una campaña para dirigirse a los miembros del plan &quot;Básico&quot; y comprender la diferencia al utilizar diferentes configuraciones de Campaña orquestada en las configuraciones de canal de correo electrónico.
