...
La activación con aplicaciones Experience Cloud se alinea con la variable [Modelo conocido de activación del cliente](known.md).
...
* Cree perspectivas enriquecidas a partir de datos multicanal, incluidos datos de comportamiento en línea y modelos de ciencia de datos, para enriquecer el perfil del cliente en tiempo real en Experience Platform, que luego se puede compartir con aplicaciones de Experience Cloud.
...
Consulte los [guardas de la página de información general sobre la activación de audiencias y perfiles.](overview.md) y [protecciones de implementación](../experience-platform/deployment/guardrails.md) página.
...
* Consulte los [modelos de recorridos del cliente](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/b2b-activation/b2bactivation.html?lang=en) para obtener más información sobre el uso compartido de perfiles y audiencias de Real-time Customer Data Platform en Campaign y Journey Optimizer.

### Uso compartido de audiencias de Real-time Customer Data Platform con el Marketo Engage

* Consulte la [Planes de activación B2B](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/b2b-activation/b2bactivation.html?lang=en) para obtener más información sobre cómo compartir perfiles y audiencias de Real-time Customer Data Platform con Marketo Engage.

### Uso compartido de audiencias de Real-time Customer Data Platform con el Customer Journey Analytics

* Consulte la [Audiencias RTCDP compartidas con el Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/ingest-aep-segments.html?lang=en) para obtener más información sobre cómo compartir audiencias de Real-time Customer Data Platform con Customer Journey Analytics.
