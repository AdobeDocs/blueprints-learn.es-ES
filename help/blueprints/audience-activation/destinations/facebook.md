...
<img src="../assets/facebook.svg" alt="Arquitectura de referencia para la activación de Facebook Custom Audiences" style="width:90%; border:1px solid #4a4a4a" class="modal-image" />
