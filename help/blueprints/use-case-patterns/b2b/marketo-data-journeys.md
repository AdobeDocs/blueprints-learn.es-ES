...
| [Journey Optimizer B2B Edition - Acciones de Marketo Engage](https://experienceleague.adobe.com/es/docs/journey-optimizer-b2b/user/account-journeys/journey-nodes/action-nodes#marketo-engage-actions) | Sincronice Account-Based Marketing en Journey Optimizer B2B Edition con los esfuerzos basados en posibles clientes en Marketo Engage mediante acciones basadas en personas para administrar los miembros de la lista y solicitar campañas. |
...
1. Instale esquemas B2B y áreas de nombres mediante cualquiera de las siguientes opciones:
   ...
   * Usar [plantillas](https://experienceleague.adobe.com/es/docs/experience-platform/sources/ui-tutorials/templates) en la interfaz de usuario de Platform
...
1. Complete la [configuración XDM](https://experienceleague.adobe.com/es/docs/journey-optimizer-b2b/user/admin/xdm-field-management/xdm-field-management){target="_blank"}.
...
1. Configure el [conector de origen de Marketo Engage](https://experienceleague.adobe.com/es/docs/experience-platform/sources/connectors/adobe-applications/marketo/marketo).
   * Use el diccionario de datos para definir [Import mapping](https://experienceleague.adobe.com/es/docs/experience-platform/data-prep/ui/mapping#import-mapping) para el conector de origen.
...
1. Implementar [reglas de vinculación de gráficos de identidad](https://experienceleague.adobe.com/es/docs/experience-platform/identity/features/identity-graph-linking-rules/overview) para Personas:
...
1. Habilite los conjuntos de datos de persona, compañías, oportunidades y actividades para [perfiles](https://experienceleague.adobe.com/es/docs/experience-platform/catalog/datasets/user-guide#enable-profile)
1. Defina su primera [audiencia de cuenta](https://experienceleague.adobe.com/es/docs/journey-optimizer-b2b/user/audiences/account-audience-overview)
1. Use la audiencia de cuenta para definir un [grupo de compra](https://experienceleague.adobe.com/es/docs/journey-optimizer-b2b/user/accounts/buying-groups/buying-groups-overview) o un [recorrido de cuenta](https://experienceleague.adobe.com/es/docs/journey-optimizer-b2b/user/account-journeys/journey-overview).
...
* **Usar los campos de identidad predeterminados:**
  * _email_ y _b2b_ person_ deben conservarse como campos de identidad en el esquema Person para admitir la vinculación de identidad y la activación de audiencia.
...
* **Usar asignaciones predeterminadas para AJO B2B:**
  * Adopte las [asignaciones de campos estándar](https://experienceleague.adobe.com/es/docs/journey-optimizer-b2b/user/admin/xdm-field-management/field-mapping) para Journey Optimizer B2B Edition a fin de garantizar la compatibilidad con la lógica de grupo de compra y la orquestación de recorrido.
...
* [Administración de campos XDM (Journey Optimizer B2B Edition)](https://experienceleague.adobe.com/es/docs/journey-optimizer-b2b/user/admin/xdm-field-management/xdm-field-management)
