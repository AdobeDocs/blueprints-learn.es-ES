...
>[!NOTE]
>
>El acceso al perfil de Edge está diseñado específicamente para casos de uso de alto rendimiento y baja latencia, como la personalización de entrada web/móvil y la toma de decisiones de oferta en tiempo real. Para escenarios de menor rendimiento, como soporte asistido por el agente o interacciones de ventas, la API de búsqueda de perfiles de concentrador es más apropiada. Consulte el [Modelo de acceso a perfiles en tiempo real para escenarios de soporte y ventas](/help/blueprints/use-case-patterns/audience-building-activation/real-time-profile-lookup.md) para obtener acceso a perfiles basados en concentradores.
