...
- Se han implementado esquemas XDM B2B: clases de cuenta, persona, oportunidad, campaña y miembro de campaña con grupos de campos requeridos
...
- Proveedor de SMS configurado (si el canal de SMS se usa en las recorridos de la cuenta): credenciales de [!DNL Sinch], [!DNL Twilio] o [!DNL Infobip] aprovisionadas
...
- Taxonomía de intereses de soluciones definida: lista de productos/servicios que tendrán grupos de compra asociados
- Plantillas de funciones de grupo de compra diseñadas: personas y funciones necesarias para cada interés de la solución (por ejemplo, Comprador económico, Evaluador técnico, Campeón)
