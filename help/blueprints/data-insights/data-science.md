...
* Para obtener más información sobre las guardas y las latencias de extremo a extremo sobre la ingesta de resultados de ciencia de datos en Experience Platform y Real-Time Customer Profile, consulte las guardas de ingesta de datos y el diagrama de latencia que aparecen en el [documento de guardas de implementación](../experience-platform/deployment/guardrails.md).
